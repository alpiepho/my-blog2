...
extra = [
  ...
  },
  {
    ...
    notes: "",
    ideas: "TODO: Revive and deploy on GH Pages with GH Actions",
  },
  {
...
function finish(header, jsonData) {
  ...
  **NOTE:** This lists " +
  ...
  jsonData.forEach((element, index) => {
    forkStr = ""
    if (element.fork)
      forkStr = '<span style="color:orange;font-weight:200">[fork]</span> '
    languageStr = ""
    if (element.language)
      languageStr =
        ...
        "]</span> "
    console.log(
      "### " + (index + 1) + ") " + forkStr + element.name + languageStr
    )
    if (element.png) {
      console.log(
