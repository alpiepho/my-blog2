...
(Warning: many images) This a summary of all the Github Repos I have added over the years.  Some are forks of other projects with minor changes.  Most are orignal works.
  ...
  **NOTE:** This lists 64 repos total, 6 forked, and 58 my public.
  
  

### 1) any-counter<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 3) arduino_12v_led<span style="color:grey;font-weight:200">[c++]</span> 
...
### 4) code_challenges<span style="color:grey;font-weight:200">[c]</span> 
...
### 5) css-grid-resume<span style="color:grey;font-weight:200">[html]</span> 
...
### 6) css-grid-resume-mine<span style="color:grey;font-weight:200">[html]</span> 
...
### 7) css-whack-a-mole<span style="color:grey;font-weight:200">[css]</span> 
...
### 8) esp32-dht11<span style="color:grey;font-weight:200">[c++]</span> 
...
### 9) esp32-pir<span style="color:grey;font-weight:200">[c++]</span> 
...
### 10) fcc-fe-simon-game<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 11) fcc-fe-tic-tac-toe<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 12) <span style="color:orange;font-weight:200">[fork]</span> gatsby-gh-pages-action<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 13) gc-stats<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 14) gitprime-patterns<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 15) go_wasm<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 16) <span style="color:orange;font-weight:200">[fork]</span> junit-plugin<span style="color:grey;font-weight:200">[java]</span> 
[junit-plugin](https://github.com/alpiepho/junit-plugin/blob/master/README.md)
: Allows JUnit-format test results to be published
- Extended this for a work project

### 17) leadership<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 18) mental-models<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 19) my-blog<span style="color:grey;font-weight:200">[javascript]</span> 
[my-blog](https://github.com/alpiepho/my-blog/blob/master/README.md)
: My first blog based on a React/Gatsby starter project.

### 20) my-blog2<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 21) my-gatsby-project<span style="color:grey;font-weight:200">[css]</span> 
...
### 22) my-gatsby-project-netlify<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 23) <span style="color:orange;font-weight:200">[fork]</span> pi-gen<span style="color:grey;font-weight:200">[shell]</span> 
...
### 24) project-portfolio<span style="color:grey;font-weight:200">[html]</span> 
...
### 25) project-portfolio-html<span style="color:grey;font-weight:200">[html]</span> 
[project-portfolio-html](https://github.com/alpiepho/project-portfolio-html/blob/master/README.md)
: Original html version

### 26) project-portfolio0<span style="color:grey;font-weight:200">[html]</span> 
[project-portfolio0](https://github.com/alpiepho/project-portfolio0)
: Original portfolio written in HTML, Javascript and CSS

### 27) project-portfolio1<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 28) project-portfolio2<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 29) project-portfolio3<span style="color:grey;font-weight:200">[javascript]</span> 
[project-portfolio3](https://github.com/alpiepho/project-portfolio3/blob/master/README.md)
: Portfolio ported to Jekyll

### 30) pup-learning<span style="color:grey;font-weight:200">[html]</span> 
...
### 31) pup-lynda<span style="color:grey;font-weight:200">[html]</span> 
...
### 32) pup-parse-bsb<span style="color:grey;font-weight:200">[javascript]</span> 
[pup-parse-bsb](https://github.com/alpiepho/pup-parse-bsb/blob/master/README.md)
: Parse baseball scores using puppeteer

### 33) pup-rally<span style="color:grey;font-weight:200">[javascript]</span> 
[pup-rally](https://github.com/alpiepho/pup-rally/blob/master/README.md)
: (see link)

### 34) pure-css-daily-challenges<span style="color:grey;font-weight:200">[css]</span> 
...
### 35) pwa-presentation<span style="color:grey;font-weight:200">[javascript]</span> 
[pwa-presentation](https://github.com/alpiepho/pwa-presentation/blob/master/README.md)
: Slides for my upcoming PWA Presentation

### 36) py-gists<span style="color:grey;font-weight:200">[python]</span> 
...
### 37) py-parse-bsb<span style="color:grey;font-weight:200">[python]</span> 
...
### 39) react-stats-bsb<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 40) <span style="color:orange;font-weight:200">[fork]</span> renderjson
[renderjson](https://github.com/alpiepho/renderjson/blob/master/README.md)
: Render JSON into collapsible HTML

### 41) rpi_parking_sensor<span style="color:grey;font-weight:200">[python]</span> 
...
### 42) rpn-calc-chrome-extension<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 43) rpn-calc-vscode-extension<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 44) rpn-hex-calculator-mobile<span style="color:grey;font-weight:200">[c#]</span> 
...
### 45) simple-score-vb-error<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 46) simple-score-vb-serve<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 47) simple-score-volleyball-pwa<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 51) site-evaluation-larimer-county-workforce-development
...
### 57) site-evaluation-triplecrown
[site-evaluation-triplecrown](https://github.com/alpiepho/site-evaluation-triplecrown/blob/master/README.md)
: Complimentary site evaluation.

### 58) state-web-development-2018-2019-withD3-pwa<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 59) state-web-development-2018-2019-withD3-static<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 60) terms-pwa-starter<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 62) <span style="color:orange;font-weight:200">[fork]</span> vscode<span style="color:grey;font-weight:200">[typescript]</span> 
...
### 63) <span style="color:orange;font-weight:200">[fork]</span> vscode-diff
