...
(Warning: many images) This a summary of all the Github Repos I have added over the years.  Some are forks of other projects with minor changes.  Most are orignal works.
  ...
  **NOTE:** This lists 60 repos total, 5 forked, and 55 my public.
...
### 30) pup-parse-bsb<span style="color:grey;font-weight:200">[javascript]</span> 
[pup-parse-bsb](https://github.com/alpiepho/pup-parse-bsb/blob/master/README.md)
: Parse baseball scores using puppeteer

### 31) pure-css-daily-challenges<span style="color:grey;font-weight:200">[css]</span> 
...
### 32) pwa-presentation<span style="color:grey;font-weight:200">[javascript]</span> 
[pwa-presentation](https://github.com/alpiepho/pwa-presentation/blob/master/README.md)
: Slides for my upcoming PWA Presentation

### 33) py-gists<span style="color:grey;font-weight:200">[python]</span> 
...
### 34) py-parse-bsb<span style="color:grey;font-weight:200">[python]</span> 
...
### 35) react-dice<span style="color:grey;font-weight:200">[javascript]</span> 
[react-dice](https://github.com/alpiepho/react-dice/blob/master/README.md)
: Very simple React Hooks example turned into a PWA

### 36) react-stats-bsb<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 37) rpi_parking_sensor<span style="color:grey;font-weight:200">[python]</span> 
...
### 38) rpn-calc-chrome-extension<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 39) rpn-calc-vscode-extension<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 40) rpn-hex-calculator-mobile<span style="color:grey;font-weight:200">[c#]</span> 
...
### 41) simple-score-vb-error<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 42) simple-score-vb-serve<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 47) site-evaluation-larimer-county-workforce-development
...
### 53) site-evaluation-triplecrown
[site-evaluation-triplecrown](https://github.com/alpiepho/site-evaluation-triplecrown/blob/master/README.md)
: Complimentary site evaluation.

### 54) state-web-development-2018-2019-withD3-pwa<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 55) state-web-development-2018-2019-withD3-static<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 56) terms-pwa-starter<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 58) <span style="color:orange;font-weight:200">[fork]</span> vscode<span style="color:grey;font-weight:200">[typescript]</span> 
...
### 59) <span style="color:orange;font-weight:200">[fork]</span> vscode-diff
